...
<div class="container">
    ...
    <section class="content-header">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fa fa-bed"></i> Rooms Lists</h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="card h-100 card-primary card-outline">
                            ...
                            <div class="card-footer d-flex justify-content-center">
                                <button type="button" class="btn btn-primary mr-2" data-toggle="modal" data-target="#editPriceModal{{ $room->room_id }}"><i class="fa fa-edit"></i> Edit</button>
                                <a href="{{ route('room.reservation', ['room_id' => $room->room_id]) }}" class="btn btn-warning
                                    @if($roomTenantsCount[$room->room_id] >= $room->room_pax)
                                        disabled
                                    @endif">
                                    <i class="fa fa-eye mr-2"></i>Reservation
                                </a>
                ...
                @empty
                    <div class="col-12">
                        <div class="alert alert-warning">
                            <p> <i class="fa fa-info-circle mr-3"></i>No Rooms available.</p>
                        </div>
                    </div>
                @endforelse
            </div>
